  ...
  return (
    <div>
      ...
      <section className="h-screen bg-gradient-to-r from-red-900 to-orange-900 text-white flex flex-col items-center justify-center">
        ...
        <p className="text-lg mb-8 max-w-md text-center">Welcome to my portfolio showcasing my projects and work.</p>
        <ShinyButton />
      </section>
      ...
      <section id="contact" className="py-20 bg-gray-700 text-center text-white">
        <div className="container mx-auto">
